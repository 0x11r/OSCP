...
If a _.git_ directory is found in a web application you can download all the content using _wget -r_ [http://web.com/.git](http://web.com/.git)_._ Then, you can see the changes made by using _git diff_.
